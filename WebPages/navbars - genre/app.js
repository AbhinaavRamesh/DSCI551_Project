...
function setGenre() {
    ...
    document.getElementById('genre-title').innerHTML = "GENRE: " + genre
	// Update the counter
	document.getElementById("genres-counter").innerHTML = 1
    populateData()
...
function actorSelect() {
    actor = document.getElementById('actor-dropdown').value
    populateData()
}
...
const appendToActor = (actors) => {
	...
	// Update the counter
	document.getElementById("actors-counter").innerHTML = parseInt(actors.length)
};
